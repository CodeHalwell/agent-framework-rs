...
| Azure AI Search / CosmosDB / ChatKit / `lab` extras | ✅ (various packages) | ✅ (various packages) | ❌ not yet | not individually tracked in this matrix |
...
- **Ecosystem**: ChatKit, Azure AI Search, CosmosDB, DurableTask/Azure Functions hosting, OTel SDK exporter wiring (AG-UI, CopilotStudio, and Purview now ship — see Serving).
